...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chart.js/auto */ \"./node_modules/chart.js/auto/auto.js\");\n// import * as flsFunctions from \"./modules/functions.js\";\r\n// flsFunctions.isWebp();\r\n\r\n\r\n\r\nconst BitCoinColor = window.getComputedStyle(\r\n  document.querySelector(\".first-card\")\r\n).backgroundColor;\r\nconst EthereumeColor = window.getComputedStyle(\r\n  document.querySelector(\".second-card\")\r\n).backgroundColor;\r\nconst RippleColor = window.getComputedStyle(\r\n  document.querySelector(\".third-card\")\r\n).backgroundColor;\r\n\r\n/* ================CANVAS================================== */\r\nconst setLabelLength = (n) => \" \".repeat(n).split(\"\");\r\nconst generateArray = () =>\r\n  [...new Array(20)].map(() => Math.round(Math.random() * 50));\r\n\r\nconst firstCanvas = document.getElementById(\"first-canvas\").getContext(\"2d\");\r\nchart_js_auto__WEBPACK_IMPORTED_MODULE_0__[\"default\"].defaults.plugins.legend.display = false;\r\n\r\nnew chart_js_auto__WEBPACK_IMPORTED_MODULE_0__[\"default\"](firstCanvas, {\r\n  type: \"line\",\r\n  data: {\r\n    labels: setLabelLength(20),\r\n    datasets: [\r\n      {\r\n        data: generateArray(),\r\n        borderWidth: 2,\r\n        pointBorderWidth: 0,\r\n        lineTension: 0.4,\r\n        borderColor: BitCoinColor,\r\n        pointBackgroundColor: \"rgba(0, 0, 0, 0)\",\r\n      },\r\n    ],\r\n  },\r\n  options: {\r\n    tooltips: {\r\n      enabled: false,\r\n    },\r\n    animation: {\r\n      duration: 2000,\r\n      easing: \"easeIn\",\r\n    },\r\n\r\n    events: [],\r\n    responsive: false,\r\n    scales: {\r\n      x: {\r\n        display: false,\r\n      },\r\n      y: {\r\n        display: false,\r\n      },\r\n    },\r\n  },\r\n});\r\n\r\nconst secondCanvas = document.getElementById(\"second-canvas\").getContext(\"2d\");\r\nchart_js_auto__WEBPACK_IMPORTED_MODULE_0__[\"default\"].defaults.plugins.legend.display = false;\r\n\r\nnew chart_js_auto__WEBPACK_IMPORTED_MODULE_0__[\"default\"](secondCanvas, {\r\n  type: \"line\",\r\n  data: {\r\n    labels: setLabelLength(20),\r\n    datasets: [\r\n      {\r\n        data: generateArray(),\r\n        borderWidth: 2,\r\n        pointBorderWidth: 0,\r\n        lineTension: 0.4,\r\n        borderColor: EthereumeColor,\r\n        pointBackgroundColor: \"rgba(0, 0, 0, 0)\",\r\n      },\r\n    ],\r\n  },\r\n  options: {\r\n    tooltips: {\r\n      enabled: false,\r\n    },\r\n    animation: {\r\n      duration: 2000,\r\n      easing: \"easeIn\",\r\n    },\r\n\r\n    events: [],\r\n    responsive: false,\r\n    scales: {\r\n      x: {\r\n        display: false,\r\n      },\r\n      y: {\r\n        display: false,\r\n      },\r\n    },\r\n  },\r\n});\r\n\r\nconst thirdCanvas = document.getElementById(\"third-canvas\").getContext(\"2d\");\r\nchart_js_auto__WEBPACK_IMPORTED_MODULE_0__[\"default\"].defaults.plugins.legend.display = false;\r\n\r\nnew chart_js_auto__WEBPACK_IMPORTED_MODULE_0__[\"default\"](thirdCanvas, {\r\n  type: \"line\",\r\n  data: {\r\n    labels: setLabelLength(20),\r\n    datasets: [\r\n      {\r\n        data: generateArray(),\r\n        borderWidth: 2,\r\n        pointBorderWidth: 0,\r\n        lineTension: 0.4,\r\n        borderColor: RippleColor,\r\n        pointBackgroundColor: \"rgba(0, 0, 0, 0)\",\r\n      },\r\n    ],\r\n  },\r\n  options: {\r\n    tooltips: {\r\n      enabled: false,\r\n    },\r\n    animation: {\r\n      duration: 2000,\r\n      easing: \"easeIn\",\r\n    },\r\n\r\n    events: [],\r\n    responsive: false,\r\n    scales: {\r\n      x: {\r\n        display: false,\r\n      },\r\n      y: {\r\n        display: false,\r\n      },\r\n    },\r\n  },\r\n});\r\n\r\n/* =================NUMBERS=========================== */\r\nconst event = () => {\r\n  if (window.pageYOffset > 300) {\r\n    const num = document.querySelectorAll(\".item-num\");\r\n    const letter = document.querySelectorAll(\".item-letter\");\r\n    const sign = document.querySelectorAll(\".item-sign\");\r\n    let item = 0;\r\n    /* =============FIRST============ */\r\n    num[0].style.transform = \"translateY(\" + (item - 30) + \"%)\";\r\n    num[1].style.transform = \"translateY(\" + (item - 40) + \"%)\";\r\n    letter[0].style.transform = \"translateY(\" + (item - 80) + \"%)\";\r\n    sign[0].style.transform = \"translateY(\" + (item - 40) + \"%)\";\r\n    /* =============Second============ */\r\n\r\n    num[2].style.transform = \"translateY(\" + item + \"%)\";\r\n    num[3].style.transform = \"translateY(\" + (item - 10) + \"%)\";\r\n    num[4].style.transform = \"translateY(\" + (item - 90) + \"%)\";\r\n    /* =============Third============ */\r\n\r\n    num[5].style.transform = \"translateY(\" + (item - 60) + \"%)\";\r\n    num[6].style.transform = \"translateY(\" + (item - 20) + \"%)\";\r\n    letter[1].style.transform = \"translateY(\" + (item - 80) + \"%)\";\r\n    sign[1].style.transform = \"translateY(\" + (item - 60) + \"%)\";\r\n    /* =============Fourth============ */\r\n\r\n    sign[2].style.transform = \"translateY(\" + (item - 70) + \"%)\";\r\n    num[7].style.transform = \"translateY(\" + (item - 30) + \"%)\";\r\n    num[8].style.transform = \"translateY(\" + (item - 60) + \"%)\";\r\n    num[9].style.transform = \"translateY(\" + (item - 90) + \"%)\";\r\n    letter[2].style.transform = \"translateY(\" + (item - 90) + \"%)\";\r\n    window.removeEventListener(\"scroll\", event);\r\n  }\r\n};\r\n\r\nwindow.addEventListener(\"scroll\", event);\r\n\r\n/* ===============ACCORDEON======================== */\r\n\r\nconst accordeon = document.querySelectorAll(\".accordeon__item-btn\");\r\n\r\naccordeon.forEach((i) => {\r\n  i.addEventListener(\"click\", () => {\r\n    let nextText = i.parentElement.nextElementSibling;\r\n\r\n    if (nextText.style.maxHeight == 0 || nextText.style.maxHeight == 0 + \"px\") {\r\n      nextText.style.maxHeight = nextText.scrollHeight + \"px\";\r\n      i.firstElementChild.classList.add(\"opensvg\");\r\n    } else {\r\n      nextText.style.maxHeight = 0;\r\n      i.firstElementChild.classList.remove(\"opensvg\");\r\n    }\r\n  });\r\n});\r\n\n\n//# sourceURL=webpack://main/./src/js/app.js?");
